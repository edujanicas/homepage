...
import logoUnbabel from '@/images/logos/unbabel.svg'
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink 
              href="https://bsky.app/profile/edujanicas.bsky.social" 
              aria-label="Follow on Bluesky" 
              icon={XIcon} 
            />
            <SocialLink
              href="https://github.com/edujanicas"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/edujanicas/"
